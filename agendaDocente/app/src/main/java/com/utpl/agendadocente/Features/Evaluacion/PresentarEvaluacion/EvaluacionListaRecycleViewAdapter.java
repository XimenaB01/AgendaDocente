...
import com.utpl.agendadocente.Features.Evaluacion.ActualizarEvaluacion.ActualizarEvaluacionListener;
...
public class EvaluacionListaRecycleViewAdapter extends RecyclerView.Adapter<EvaluacionListaRecycleViewAdapter.EvaluacionViewHolder> {
    ...
    public void onBindViewHolder(final EvaluacionViewHolder holder, int position) {
        ...
        holder.editarEva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                actEva.show(((EvaluacionListarActivity)context).getSupportFragmentManager(), utilidades.ACTUALIZAR);
            }
        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                evaluacionDetalle.show(((EvaluacionListarActivity)context).getSupportFragmentManager(),"tag");
            }
        });
    }
    ...
    private void eliminarEvaluacion(int position){
        ...
        if (count > 0){
            ...
            notifyDataSetChanged();
            ((EvaluacionListarActivity) context).viewVisibility();
