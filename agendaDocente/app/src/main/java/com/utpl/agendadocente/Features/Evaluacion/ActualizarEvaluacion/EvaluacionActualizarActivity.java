package com.utpl.agendadocente.Features.Evaluacion.ActualizarEvaluacion;
...
public class EvaluacionActualizarActivity extends DialogFragment implements DialogDatePicker.DatePickerListener {
    ...
    private void spinnercuestio(){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(Objects.requireNonNull(getContext()),R.layout.spinner_item_style_pesonal, listCuetAct);
