...
import com.utpl.agendadocente.Features.Tarea.ActualizarTarea.ActualizarTareaListener;
import com.utpl.agendadocente.Features.Tarea.ActualizarTarea.TareaActualizarActivity;
...
public class TareaListaRecycleViewAdapter extends RecyclerView.Adapter<TareaListaRecycleViewAdapter.TareaViewHolder> {
    ...
    public void onBindViewHolder(TareaViewHolder holder, int position) {
        ...
        holder.editarTar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                actTar.show(((TareaListarActivity)context).getSupportFragmentManager(), utilidades.ACTUALIZAR);
            }
        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tareaDetalle.show(((TareaListarActivity)context).getSupportFragmentManager(),"tag");
            }
        });
    }
    ...
    private void eliminarTarea(int position){
        ...
        if (count > 0){
            ...
            notifyDataSetChanged();
            ((TareaListarActivity) context).viewVisibility();
