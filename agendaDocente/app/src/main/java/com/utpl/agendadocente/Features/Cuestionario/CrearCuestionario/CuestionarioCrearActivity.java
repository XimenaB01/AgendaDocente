package com.utpl.agendadocente.Features.Cuestionario.CrearCuestionario;
...
public class CuestionarioCrearActivity extends DialogFragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            ...
            throw new ClassCastException(Objects.requireNonNull(getActivity()).toString() + " must implements CuestionarioCrearListener");
        }
    }
