...
import com.utpl.agendadocente.Features.Horario.ActualizarHorario.ActualizarHorarioListener;
import com.utpl.agendadocente.Features.Horario.ActualizarHorario.HorarioActualizarActivity;
...
public class HorarioListaRecycleViewAdapter extends RecyclerView.Adapter<HorarioListaRecycleViewAdapter.HorarioViewHolder>{
    ...
    public void onBindViewHolder(final HorarioViewHolder holder, int position) {
        ...
        holder.editarHor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                actHor.show(((HorarioListarActivity)context).getSupportFragmentManager(), utilidades.ACTUALIZAR);
            }
        });
    }
    ...
    private void eliminarHorario(int position){
        ...
        if (count > 0){
            ...
            notifyDataSetChanged();
            ((HorarioListarActivity) context).viewVisibility();
