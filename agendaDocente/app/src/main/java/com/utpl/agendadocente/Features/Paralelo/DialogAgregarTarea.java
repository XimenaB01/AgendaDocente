...
public class DialogAgregarTarea extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = view.findViewById(R.id.toolbarAgreTar);
        TextView nuevaTarea = view.findViewById(R.id.btnNTarea);
        RecyclerView listaTareas = view.findViewById(R.id.checkListTarea);
